...
public class SantaBlocks {
    ...
    private static final DeferredRegister.Blocks REGISTER = DeferredRegister.createBlocks(SantaLogisticsConstants.MOD_ID);
    private static final DeferredRegister.Items ITEMS = DeferredRegister.createItems(SantaLogisticsConstants.MOD_ID);
